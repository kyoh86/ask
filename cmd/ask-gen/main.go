...
func generate(definition interface{}, templateText, filename string) (retErr error) {
	buf, readErr := os.ReadFile(filename + ".yaml")
	if readErr != nil {
		return readErr
	}
	...
	out, openErr := os.OpenFile(filename+"_gen.go", os.O_WRONLY|os.O_TRUNC|os.O_CREATE, 0o644)
	if openErr != nil {
		return openErr
	}
	defer func() {
	...
	if err := tmp.Execute(out, map[string]any{"definition": definition}); err != nil {
		return err
	}
...
func genTypes() {
	...
	typesTemplate := `// Code generated by ask-gen. DO NOT EDIT!!
...
func genPrototype() {
	...
	prototypeTemplate := `// Code generated by ask-gen. DO NOT EDIT!!
